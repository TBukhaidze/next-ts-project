  ...
  return (
    <main className="flex items-center h-screen relative bg-cover bg-[url('/assets/bg-explosion.png')]">
      ...
      <div className="flex flex-col gap-3 z-[10] pl-40 pt-20">
        ...
        <p className="text-[16px] tegt-gray-200 md:text-gray-400 mb-10 md:pb-2 max-w-[400px]">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla
          voluptatum quia itaque impedit quos quis ab tenetur, aperiam hic
          dolore.
        </p>
        <div className="relative w-[100p] h0-[100px] md:w[160px] md:h[160px] md:h[160px] mt-5">
          <Image
